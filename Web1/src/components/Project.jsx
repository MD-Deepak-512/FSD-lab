import portfoliopic from '../assets/Screenshot (29).png'
import Hostelmanagementpic from '../assets/Screenshot (30).png';
import webtech from '../assets/Screenshot (33).png';
const Project = () => {
  return (
    <>
    <div id='project-sec'>
    <div className='flex flex-wrap justify-center items-center m-3 gap-4'>
            <div className="block rounded-lg bg-white  dark:bg-neutral-700 max-w-xs"id="Card-project-sec">
                    <a href="">
                        <img
                    ...
                    {/* card-2 */}
                <div className="block rounded-lg  dark:bg-neutral-700 max-w-xs"id="Card-project-sec">
                    <a href="">
                        <img
                        className="rounded-t-lg"
                        src={webtech}
